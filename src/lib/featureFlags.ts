...
export const FEATURE_FLAGS = {
  V1_LAUNCH: {
    ...
    showUniversity: true,          // S24 Innovation Academy has full access (NEW)
    ...
    universityHasLessons: true,    // S24 Innovation Academy: full lesson access (NEW)
    universityHasCodeEditor: true, // S24 Innovation Academy: integrated code editor (NEW)
    universityHasProjects: true,   // S24 Innovation Academy: project-based learning (NEW)
    // Global Settings
