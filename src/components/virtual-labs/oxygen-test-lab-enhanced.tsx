...
import { Flame, Sparkles, CheckCircle, XCircle, Award, Trophy, TestTube, AlertTriangle, Eye, Wind } from 'lucide-react';
import confetti from 'canvas-confetti';
import { useLabProgress } from '@/stores/lab-progress-store';

type Gas = 'oxygen' | 'air' | 'none';
type SplintState = 'idle' | 'glowing' | 'relit' | 'extinguished';
...
export function OxygenTestLabEnhanced() {
  ...
  const [selectedGas, setSelectedGas] = React.useState<Gas>('none');
  const [splintState, setSplintState] = React.useState<SplintState>('idle');
  ...
  const gasData = {
    oxygen: {
      ...
      label: 'Oxygen Gas (O₂)',
      description: 'Pure oxygen gas - supports combustion vigorously',
      icon: '💨',
    },
    air: {
      color: 'from-gray-100 to-gray-200',
      darkColor: 'dark:from-gray-700 dark:to-gray-600',
      label: 'Air (21% O₂)',
      description: 'Normal air - contains about 21% oxygen',
      icon: '🌬️',
    },
  };
  ...
  const quizQuestions = [
    {
      question: "What happens when a glowing splint is placed in pure oxygen?",
      options: [
        "It goes out",
        "It relights with a flame",
        "Nothing happens",
        "It produces smoke"
      ],
      correct: 1,
    ...
    {
      question: "Why does oxygen relight a glowing splint?",
      options: [
        "Oxygen is flammable",
    ...
    {
      question: "What happens to a glowing splint in normal air?",
      options: [
        "It relights with a bright flame",
        "It continues glowing or goes out",
        "It explodes",
        "It turns blue"
      ],
      correct: 1,
  ...
  const handleTestGas = () => {
    if (selectedGas === 'none') return;

    setIsTesting(true);
    setSplintState('glowing');

    // Simulate test sequence
    setTimeout(() => {
      if (selectedGas === 'oxygen') {
        setSplintState('relit');
        const result: TestResult = {
          gas: selectedGas,
          splintState: 'relit',
          observation: 'The glowing splint relights with a bright flame! This confirms the presence of oxygen gas.',
        };
        setTestResults((prev) => [...prev, result]);
      } else if (selectedGas === 'air') {
        setSplintState('extinguished');
        const result: TestResult = {
          gas: selectedGas,
          splintState: 'extinguished',
          observation: 'The glowing splint continues to glow briefly then goes out. Air contains only 21% oxygen - not enough to relight the splint.',
        };
        setTestResults((prev) => [...prev, result]);
      }
              ...
              >
                <div className="prose dark:prose-invert max-w-none">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-amber-800 dark:text-amber-200 space-y-1 mt-2">
                          ...
                          <li>• Never point test tubes at yourself or others</li>
                          <li>• Have a fire extinguisher nearby</li>
                          <li>• Handle flames with care</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <ul className="grid grid-cols-2 gap-2">
                    <li>✓ Test tubes with oxygen gas</li>
                    <li>✓ Test tubes with air</li>
                  ...
                  >
                    ...
                    <div className="text-left space-y-2">
                      ...
                      {splintState === 'relit' && (
                        ...
                        >
                          <p className="font-medium text-lg">🔥 Splint Relights!</p>
                ...
                <div className="prose dark:prose-invert max-w-none space-y-6">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-950 p-5 rounded-lg">
                    ...
                    <ul className="space-y-2 text-amber-800 dark:text-amber-200">
                      ...
                      <li>
                        <strong>Chemical Reaction:</strong> Wood + O₂ → CO₂ + H₂O + Energy (heat & light)
                      </li>
                      <li>
                    ...
                    <div className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 rounded-lg border-2">
                      ...
                      <p className="text-muted-foreground">
                        {quizScore === quizQuestions.length
                          ? '🎉 Perfect! You mastered the oxygen test!'
            ...
            {step === 'complete' && (
              ...
              >
                ...
                <div className="prose dark:prose-invert max-w-none text-left bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2">
                    <li>✓ How to perform the glowing splint test for oxygen</li>
                    <li>✓ Pure oxygen relights a glowing splint with a bright flame</li>
                    <li>✓ Normal air (21% O₂) is not concentrated enough to relight the splint</li>
                    <li>✓ Oxygen supports combustion but is not flammable itself</li>
                    <li>✓ Real-world applications in medicine, fire safety, and industry</li>
                  </ul>
                </div>
